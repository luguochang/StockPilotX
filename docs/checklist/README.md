...
This directory tracks executable checklists and progress logs for large implementation batches.

## Structure
- `docs/checklist/YYYY-MM-DD/README.md`: index for the day.
...
- Keep commit ids in execution log for traceability.
